...
class MyHTC(HTCFile):
    ...
    def _update_ctrl_params(self, ctrl_dict, min_rot_speed=None, rated_rot_speed=None):
    ...
    def make_tower_exclusion_zone(self, omega_L, omega_H, Q_gL, Q_gH, tau=25):
        """
        Add a rotational speed exclusion zone for the tower resonance.

        Parameters
        ----------
        omega_L : int | float
            Lower rotational speed limit of the exclusion zone [rad/s].
        omega_H : int | float
            Upper rotational speed limit of the exclusion zone [rad/s].
        Q_gL : int | float
            Generator torque at the lower rotational speed limit of the
            exclusion zone [Nm].
        Q_gH : int | float
            Generator torque at the upper rotational speed limit of the
            exclusion zone [Nm].
        tau : int | float, optional
            Time constant of reference switching at exclusion zone [s].
            The default is 25.
        ...
        """
        self.dll.type2_dll__1.init.constant__53 = [53, omega_L]
        self.dll.type2_dll__1.init.constant__54 = [54, Q_gL]
        self.dll.type2_dll__1.init.constant__55 = [55, omega_H]
        self.dll.type2_dll__1.init.constant__56 = [56, Q_gH]
        self.dll.type2_dll__1.init.constant__57 = [57, tau]
